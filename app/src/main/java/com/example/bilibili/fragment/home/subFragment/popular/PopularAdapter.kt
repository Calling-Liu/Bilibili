...
class PopularAdapter(val mList:ArrayList<String>, val mImageList:ArrayList<Int>, val mContext:Context) : RecyclerView.Adapter<PopularAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularAdapter.MyViewHolder {
        val contentView = LayoutInflater.from(mContext).inflate(R.layout.popular_adapter, parent, false)
    ...
    class MyViewHolder(val view: View) : RecyclerView.ViewHolder(view){
        val tv:TextView = view.findViewById(R.id.text_popular_adapter)
        val image_list:ImageView = view.findViewById(R.id.image_popular_adapter)
    }
    //我们的事件接口，可以在这里扩充
